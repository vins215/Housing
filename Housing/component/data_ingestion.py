...
class DataIngestion:
    ...
    def download_housing_data(self)->str:
        try:
            download_url = self.data_ingestion_config.data_set_download_URL
            ...
            logging.info("file[{tgz_file_path}] has been downloaded succesfully")
    ...
    def extract_tgz_file(self,tgz_file_path:str):
        try:
            ...
            logging.info(f"Extracting tgz file :[{tgz_file_path}]into the directory[{raw_data_dir}]")
